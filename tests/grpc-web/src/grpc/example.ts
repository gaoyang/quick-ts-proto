...
export interface ExampleGrpcService {
  ...
  ): Observable<SubscribeUserInfoChangedResponse>;
}
...
export class ExampleGrpcServiceClientImpl implements ExampleGrpcService {
  ...
  SubscribeUserInfoChanged(
    ...
    return this.rpc.invoke(ExampleGrpcServiceSubscribeUserInfoChangedDesc, Empty.fromPartial(request), metadata);
  }
}
...
export const ExampleGrpcServiceSubscribeUserInfoChangedDesc: UnaryMethodDefinitionish = {
  methodName: "SubscribeUserInfoChanged",
  service: ExampleGrpcServiceDesc,
  requestStream: false,
  responseStream: true,
  requestType: {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = SubscribeUserInfoChangedResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
